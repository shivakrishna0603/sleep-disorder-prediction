...
<style>
    ...
    .card { background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.08); border-radius: 18px; padding: 1.4rem 1.5rem; margin-bottom: 1rem; backdrop-filter: blur(6px); color: #e2e2f5; }
    .card h4 { margin-top: 0; color: #e6e6ff; font-size: 1.05rem; display: flex; align-items: center; gap: 0.5rem; }
    .card p, .card li, .card b { color: #e2e2f5 !important; }

    /* Brighten default Streamlit markdown/body text against the dark background */
    .stApp p, .stApp li, .stMarkdown, .stMarkdown p {
        color: #e2e2f5 !important;
    }
    section[data-testid="stSidebar"] p, section[data-testid="stSidebar"] li,
    section[data-testid="stSidebar"] .stMarkdown {
        color: #d6d6ec !important;
    }
